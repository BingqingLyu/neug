...
## The Meta-Insight: What Graph Analysis Reveals That Code Review Can't
...
*All data in this post was generated by [CodeScope](https://github.com/codescope/codescope) using the NeuG embedded graph database. The full index (21K functions, 36K call edges, 500 commits) was built in under 5 minutes on a MacBook.*
